...
SELECT id, name, title, description, docker_image, mounts, parameters, data, created_at, started_at, finished_at, status, has_errored, error_message FROM runs WHERE is_pending = TRUE
`
...
SELECT id, name, title, description, docker_image, mounts, parameters, data, created_at, started_at, finished_at, status, has_errored, error_message FROM runs WHERE is_running = TRUE
`
